  ...
  return (
    ...
    >
      <div className="mb-6 flex items-center justify-between">
        ...
        {isAfter && <Badge variant="default" className="bg-primary text-white border-primary">Groute</Badge>}
      </div>
        ...
        {items.map((it, i) => (
          <li
            ...
            className={cn(
              ...
              "border-b",
              i === 0 && "border-t",
              isAfter ? "border-[#E1ECFD] text-foreground font-medium" : "border-border text-muted-foreground line-through decoration-muted-2/50",
              "text-[15px]",
            )}
          >
            <span
              className={cn(
                ...
                isAfter ? "bg-primary/12 text-primary" : "bg-muted-2/15 text-muted-2",
              )}
            >
              <Icon
      ...
      <div className="container-page">
        <div className="mx-auto mb-14 max-w-[700px] text-center">
          ...
          <p className="mx-auto mt-4 max-w-[540px] text-[17px] leading-relaxed text-muted-foreground">
            Pet alata, papira i WhatsApp poruka pretvaramo u jedan sistem. Bez kopiranja podataka.
          </p>
        </div>
