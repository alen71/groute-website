      ...
      <div className="container-page relative pt-[72px] pb-20">
        <div className="mx-auto max-w-[820px] text-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/[0.06] px-3.5 py-1.5 text-xs font-medium text-[#D6DEEC] backdrop-blur">
            ...
            Fleet management za transportere na Balkanu
          </span>
          <h1 className="mt-6 text-[clamp(34px,5.2vw,64px)] font-semibold leading-[1.05] tracking-[-0.03em] text-white">
            Svaki kamion. Svaki euro.
            <br />
            <span className="text-[#9DB7F2]">Jedna komandna tabla.</span>
          </h1>
          <p className="mx-auto mt-6 max-w-[600px] text-[17px] leading-relaxed text-[#A6B1CD]">
            GPS u realnom vremenu, tahograf na daljinu i dokumenti — sve u jednom sistemu.
            Napravljeno za transportere u BiH, Srbiji i regionu.
          </p>
          <div className="mt-7 flex flex-wrap justify-center gap-3">
            <Button variant="blue" size="lg" asChild>
              <a href="#kontakt">Zakažite sastanak</a>
            </Button>
          ...
          <div className="mt-5 flex flex-wrap justify-center gap-4 text-[12.5px] text-[#8C97B5]">
            <span className="inline-flex items-center gap-1.5">
              <Icon name="check" size={13} className="text-[#9DB7F2]" /> 30 dana pilot
            </span>
            <span className="inline-flex items-center gap-1.5">
              <Icon name="check" size={13} className="text-[#9DB7F2]" /> Besplatna ugradnja
            </span>
            <span className="inline-flex items-center gap-1.5">
              <Icon name="check" size={13} className="text-[#9DB7F2]" /> GDPR usklađeno
            </span>
          </div>
        </div>
        ...
        <div className="relative mt-14">
          <PhotoPlaceholder
            dark
            label="[ FOTO — Hero shot · kamion na otvorenom putu / dispečer ekran ]"
